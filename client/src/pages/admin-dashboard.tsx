...
export default function AdminDashboard() {
  ...
  const getLuminance = (hex: string): number => {
    ...
    const rgb = cleanHex.match(/.{2}/g);
    if (!rgb || rgb.length < 3) return 1;
    const [r, g, b] = rgb.map(c => {
      const val = parseInt(c, 16) / 255;
      return isNaN(val) ? 0 : val <= 0.03928 ? val / 12.92 : Math.pow((val + 0.055) / 1.055, 2.4);
    });
                      ...
                      <div className="p-3 space-y-2">
                        ...
                        <div className="rounded border" style={{ borderColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#d1d5db" : "#4b5563" }}>
                          ...
                          <div className="grid grid-cols-3 gap-1.5 p-2">
                            <div className="text-center p-1.5 rounded" style={{ backgroundColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#f3f4f6" : "#374151" }}>
                              <p className="text-[8px] font-semibold" style={{ color: watchedTextColor || "#212529" }}>SALE RATE</p>
                              <p className="text-sm font-bold" style={{ color: watchedTextColor || "#212529" }}>₹140,760</p>
                            </div>
                            <div className="text-center p-1.5 rounded" style={{ backgroundColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#f3f4f6" : "#374151" }}>
                              <p className="text-[8px] font-semibold" style={{ color: watchedTextColor || "#212529" }}>EXCHANGE</p>
                              <p className="text-sm font-bold" style={{ color: watchedTextColor || "#212529" }}>₹139,230</p>
                            </div>
                            <div className="text-center p-1.5 rounded" style={{ backgroundColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#f3f4f6" : "#374151" }}>
                              <p className="text-[8px] font-semibold" style={{ color: watchedTextColor || "#212529" }}>PURCHASE</p>
                              <p className="text-sm font-bold" style={{ color: watchedTextColor || "#212529" }}>₹137,700</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="rounded border" style={{ borderColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#d1d5db" : "#4b5563" }}>
                          ...
                          <div className="grid grid-cols-3 gap-1.5 p-2">
                            <div className="text-center p-1.5 rounded" style={{ backgroundColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#f3f4f6" : "#374151" }}>
                              <p className="text-[8px] font-semibold" style={{ color: watchedTextColor || "#212529" }}>SALE RATE</p>
                              <p className="text-sm font-bold" style={{ color: watchedTextColor || "#212529" }}>₹250,000</p>
                            </div>
                            <div className="text-center p-1.5 rounded" style={{ backgroundColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#f3f4f6" : "#374151" }}>
                              <p className="text-[8px] font-semibold" style={{ color: watchedTextColor || "#212529" }}>EXCHANGE</p>
                              <p className="text-sm font-bold" style={{ color: watchedTextColor || "#212529" }}>₹247,000</p>
                            </div>
                            <div className="text-center p-1.5 rounded" style={{ backgroundColor: isLightColor(watchedBgColor || "#FFF8E1") ? "#f3f4f6" : "#374151" }}>
                              <p className="text-[8px] font-semibold" style={{ color: watchedTextColor || "#212529" }}>PURCHASE</p>
                              <p className="text-sm font-bold" style={{ color: watchedTextColor || "#212529" }}>₹245,000</p>
                            </div>
                          </div>
                        </div>
                      </div>
