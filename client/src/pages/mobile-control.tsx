          ...
          <CardContent>
            <div className="space-y-3 text-base md:text-xl">
              <div className="border-b pb-2">
                <p className="font-bold mb-1" style={{ color: textColor }}>24K Gold:</p>
                <div className="flex justify-between items-center text-sm md:text-base gap-1">
                  <span>Sale: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_24k_sale}</strong></span>
                  <span>Exch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_24k_exchange ?? 0}</strong></span>
                  <span>Purch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_24k_purchase}</strong></span>
                </div>
              </div>
              <div className="border-b pb-2">
                <p className="font-bold mb-1" style={{ color: textColor }}>22K Gold:</p>
                <div className="flex justify-between items-center text-sm md:text-base gap-1">
                  <span>Sale: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_22k_sale}</strong></span>
                  <span>Exch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_22k_exchange ?? 0}</strong></span>
                  <span>Purch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_22k_purchase}</strong></span>
                </div>
              </div>
              <div className="border-b pb-2">
                <p className="font-bold mb-1" style={{ color: textColor }}>18K Gold:</p>
                <div className="flex justify-between items-center text-sm md:text-base gap-1">
                  <span>Sale: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_18k_sale}</strong></span>
                  <span>Exch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_18k_exchange ?? 0}</strong></span>
                  <span>Purch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.gold_18k_purchase}</strong></span>
                </div>
              </div>
              <div>
                <p className="font-bold mb-1" style={{ color: textColor }}>Silver (Per KG):</p>
                <div className="flex justify-between items-center text-sm md:text-base gap-1">
                  <span>Sale: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.silver_per_kg_sale}</strong></span>
                  <span>Exch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.silver_per_kg_exchange ?? 0}</strong></span>
                  <span>Purch: <strong className="border border-black rounded px-1.5 py-0.5">₹{currentRates?.silver_per_kg_purchase}</strong></span>
                </div>
              </div>
            </div>
          </CardContent>
